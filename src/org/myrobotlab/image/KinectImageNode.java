...
import org.myrobotlab.opencv.OpenCVUtils;
...
public class KinectImageNode implements Serializable {
  ...
  public void convertToSerializableTypes() {
    cameraFrame = new SerializableImage(OpenCVUtils.IplImageToBufferedImage(cvCameraFrame), "camera");
    mask = new SerializableImage(OpenCVUtils.IplImageToBufferedImage(cvMask), "frame");
  }
